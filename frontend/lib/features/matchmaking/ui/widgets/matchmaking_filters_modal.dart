...
class _MatchmakingFiltersModalState extends State<MatchmakingFiltersModal> {
  ...
  final List<String> _sports = ["All Sports", "Tennis", "Badminton", "Cricket", "Basketball", "Football", "Swimming"];
  final List<String> _durations = ["Any Time", "Morning", "Afternoon", "Evening", "Night"];
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const Text("Filter Matches", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
              Row(
                children: [
                  TextButton(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      ...
                      icon: const Icon(Icons.access_time, color: AppColors.primary, size: 20),
                      decoration: InputDecoration(
                        filled: true,
                        fillColor: Colors.grey.withValues(alpha: 0.05),
                        border: OutlineInputBorder(borderRadius: BorderRadius.circular(12), borderSide: BorderSide.none),
          ...
          SizedBox(
            ...
            child: ElevatedButton.icon(
              onPressed: () {
                ...
                widget.onScan({
                  "sport": _selectedSport == "All Sports" ? null : _selectedSport,
                  "skill": _selectedSkill == "All Levels" ? null : _selectedSkill,
                  "timeDuration": _selectedDuration == "Any Time" ? null : _selectedDuration,
