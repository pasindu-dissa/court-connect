...
class DawnPatrolBadgeScreen extends StatefulWidget {
  const DawnPatrolBadgeScreen({super.key});

  @override
  State<DawnPatrolBadgeScreen> createState() => _DawnPatrolBadgeScreenState();
}

class _DawnPatrolBadgeScreenState extends State<DawnPatrolBadgeScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFF1A0A00), // Deep pre-dawn
      appBar: AppBar(
      ...
      body: Stack(
        children: [
          // Background — sunrise orange-purple gradient
          Container(
            decoration: const BoxDecoration(
              gradient: RadialGradient(
                colors: [
                  Color(0xFF4A1942), // Deep dawn purple
                  Color(0xFF1A0A00), // Dark background
                ],
              ...
              child: AnimatedBuilder(
                ...
                child: CustomPaint(
                  painter: _ConfettiPainter(
                    ...
                    colors: const [Color(0xFFFF7043), Color(0xFFFFB74D), Colors.pinkAccent, Colors.white],
                  ),
                ),
              ),
            ),
          ...
          builder: (context, child) {
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: const Color(0xFFFF7043).withValues(alpha: 0.3 * _pulseController.value),
                    blurRadius: 40,
                    spreadRadius: 10,
                  ),
                ],
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [
                Color(0xFFFF8A65), // Sunrise orange
                Color(0xFFFF5722), // Deep orange
                Color(0xFF8D1A00), // Dark ember
              ],
            ),
            boxShadow: [
              BoxShadow(
              ...
              BoxShadow(
                color: const Color(0xFFFFCCBC).withValues(alpha: 0.4),
                blurRadius: 10,
          ...
          child: const Center(
            child: Icon(
              Icons.wb_sunny_rounded, // ☀️ Dawn Patrol
              size: 70,
              color: Colors.white,
            ),
          ),
  ...
  Widget _buildTextContent() {
    return Column(
      children: [
        ...
        Text(
          'The early bird dominates the court! This badge is awarded for booking and playing a match in the earliest available morning slots — before the world wakes up.',
              ...
              try {
                ...
                if (byteData != null) {
                  ...
                  await Share.shareXFiles(
                    [XFile(file.path)],
                    text: "I just earned 'Dawn Patrol' badge on CourtConnect! Early riser wins!",
                  );
                }
              } catch (e) {
                debugPrint('Error sharing badge: $e');
                Share.share("I just earned 'Dawn Patrol' badge on CourtConnect! Early riser wins!");
              }
            },
