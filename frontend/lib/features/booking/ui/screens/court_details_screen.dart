...
class _CourtDetailsScreenState extends State<CourtDetailsScreen> {
  ...
  Future<void> _fetchBookedSlots() async {
    ...
    final bookings = await _bookingService.getBookedSlots(
      widget.court['_id'],
      dateStr,
    );
    setState(() {
    ...
    if (mounted) {
      ...
      if (allSuccess) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text("Some slots failed to book. Please refresh."),
          ),
        );
        _fetchBookedSlots();
      }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            Text(
              matchPublished ? "Match Published!" : "Booking Confirmed!",
  ...
  Widget build(BuildContext context) {
    ...
    String image = (widget.court['images'] as List?)?.isNotEmpty == true
        ? widget.court['images'][0]
        : "";
                        ...
                        Container(
                          ...
                          child: const Row(
                            children: [
                              ...
                              Expanded(
                                child: Text(
                                  "Select the date and time slots for your Match. Booking this court will automatically publish your match.",
                                  style: TextStyle(
                                    color: Colors.blue,
                                    fontSize: 13,
                                  ),
                        ...
                        children: [
                          ...
                          IconButton(
                            onPressed: () => Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (_) =>
                                    DirectionsMapScreen(court: widget.court),
                              ),
                            ),
                            icon: Container(
                      ...
                      _isLoadingSlots
                          ...
                          : Wrap(
                              ...
                              children: _allSlots.map((slot) {
                                ...
                                bool isSelected = _selectedTimeSlots.contains(
                                  slot,
                                );
                                return GestureDetector(
                                  onTap: isBooked
                ...
                children: [
                  ...
                  Expanded(
                    child: ElevatedButton(
                      onPressed: _selectedTimeSlots.isEmpty || _isSubmitting
                          ? null
                          : _confirmBooking,
                      ...
                      child: _isSubmitting
                          ...
                          : Text(
                              isHosting
                                  ? "Book & Publish Match"
                                  : "Book ${_selectedTimeSlots.length} Slot(s)",
                              style: const TextStyle(
                                fontSize: 16,
                                fontWeight: FontWeight.bold,
                                color: Colors.white,
